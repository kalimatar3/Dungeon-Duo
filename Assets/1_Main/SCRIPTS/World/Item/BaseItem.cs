...
public abstract class BaseItem : MyBehaviour,Iinteractable,IDespawnable
{
    [Header("Components")]
    ...
    public Collider2D Box {get {return box;}}
    #endregion
    ...
    public void DeSpawn()
    {
        ItemSpawner.Instance.DeSpawnToPool(this.transform);
    }
}
