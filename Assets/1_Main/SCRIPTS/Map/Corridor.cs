...
public class Corridor : MyBehaviour {
    ...
    private HashSet<Vector2Int> CreateCorridor(Room baseroom, Room destinationroom,int width)
    {
        ...
        basegateroompositions = CreateListGatePos(basestack.Pop(),width);
        targetgaterompostions = CreateListGatePos(targetqueue.Dequeue(),width);
